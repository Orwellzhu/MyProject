		...
		strLink:function(ret,id){
			...
			strBox=['<tr>'
		                ...
		                ,'<th>'
		                	...
		                	,'<a href="#formManage_Checkforum?id='+ret.id+'"><button type="button" class="btn btn-danger btn-sm">审查</button></a>'
		                ,'</th>'
		            ,'</tr>'];
			return strBox.join('');
		},
